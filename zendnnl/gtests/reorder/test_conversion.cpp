...
TEST_P(TestReorder, FP32_BF16_CVT) {
    ...
    data_type_t src_dtype = lowoha_params.cvt_direction_swap
            ? data_type_t::f32
            : data_type_t::bf16;
    ...
    status_t fwd_status = lowoha_reorder_kernel_test(
            src_tensor, fwd_tensor, scale_tensor, zp_tensor, lowoha_params);
    ...
    status_t bwd_status = lowoha_reorder_kernel_test(
            fwd_tensor, bwd_tensor, scale_tensor, zp_tensor, bwd_params);
    ...
    compare_lowoha_reorder_output(
            bwd_tensor, src_tensor, cmp_params, is_test_successful);
...
TEST_P(TestReorder, BF16_F16_CVT) {
    ...
    data_type_t src_dtype = lowoha_params.cvt_direction_swap ? data_type_t::bf16
                                                             : data_type_t::f16;
    data_type_t dst_dtype = (src_dtype == data_type_t::bf16)
            ? data_type_t::f16
            : data_type_t::bf16;
    log_lowoha_test_info(lowoha_params, src_dtype, dst_dtype, false, false);

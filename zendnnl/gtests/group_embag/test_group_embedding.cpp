...
protected:
    ...
    void run_float_lookup_test(
            data_type_t table_dt, data_type_t output_dt, float tol) {
        GroupTensors g = build_group_embedding_tensors(tensor_factory,
                group_size, num_embeddings, embedding_dim, num_indices,
                padding_index, is_weights, fp16_scale_bias, table_dt, output_dt,
                indices_dtype);
    ...
    void run_quant_lookup_test(
            data_type_t table_dt, data_type_t output_dt, float tol) {
        GroupTensors g = build_group_embedding_quant_tensors(tensor_factory,
                group_size, num_embeddings, embedding_dim, num_indices,
                padding_index, is_weights, fp16_scale_bias, table_dt, output_dt,
                indices_dtype);

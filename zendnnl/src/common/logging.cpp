...
logger_t::logger_t()
    : log_file {}
    , log_ofstream {}
    , log_start_time {cn::steady_clock::now()}
    , log_cout_flag {true} {
    level_cache_[static_cast<size_t>(log_module_t::common)]
            = log_level_t::warning;
    level_cache_[static_cast<size_t>(log_module_t::api)] = log_level_t::warning;
    level_cache_[static_cast<size_t>(log_module_t::test)]
            = log_level_t::warning;
    level_cache_[static_cast<size_t>(log_module_t::profile)]
            = log_level_t::warning;
    level_cache_[static_cast<size_t>(log_module_t::debug)]
            = log_level_t::warning;
...
void logger_t::log_msg_r(log_module_t log_module_, log_level_t log_level_,
    ...
    std::string module_hdr
            = std::string("[") + log_module_str + std::string("]");

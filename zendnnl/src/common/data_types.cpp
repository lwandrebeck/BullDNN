...
uint32_t size_of(data_type_t data_type) {
    switch (data_type) {
        case data_type_t::none: return 0;
        ...
        case data_type_t::s8: return sizeof(prec_traits<data_type_t::s8>::type);
        case data_type_t::s4: return sizeof(prec_traits<data_type_t::s4>::type);
        ...
        case data_type_t::u8: return sizeof(prec_traits<data_type_t::u8>::type);
        case data_type_t::u4: return sizeof(prec_traits<data_type_t::u4>::type);
    }

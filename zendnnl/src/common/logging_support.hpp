...
public:
   ...
   */
    static std::string log_module_to_str(log_module_t log_module_) {
        switch (log_module_) {
            case log_module_t::common: return "COMMON ";
            case log_module_t::api: return "API    ";
            case log_module_t::test: return "TEST   ";
            case log_module_t::profile: return "PROF   ";
            case log_module_t::debug: return "DEBUG  ";
            case log_module_t::trace: return "TRACE  ";
   ...
   */
    static log_module_t str_to_log_module(std::string str_) {
        ...
        if ("common" == str_) { return log_module_t::common; }
        if ("api" == str_) { return log_module_t::api; }
        if ("test" == str_) { return log_module_t::test; }
        if ("profile" == str_) { return log_module_t::profile; }
        if ("debug" == str_) { return log_module_t::debug; }
        if ("trace" == str_) { return log_module_t::trace; }
   ...
   */
    static log_level_t str_to_log_level(std::string str_) {
        ...
        std::transform(str_.begin(), str_.end(), str_.begin(),
                [](unsigned char c) { return std::tolower(c); });
        //convert to integer value
        if ("disabled" == str_) { return log_level_t::disabled; }
        if ("error" == str_) { return log_level_t::error; }
        if ("warning" == str_) { return log_level_t::warning; }
        if ("info" == str_) { return log_level_t::info; }
        if ("verbose" == str_) { return log_level_t::verbose; }

...
status_t layer_norm_avx512_fp16(const void *input, void *output,
    ...
    using ln_row_fn_t = void (*)(const void *, void *, const void *,
            const void *, uint64_t, float, float, bool, bool);
    ...
    if (src_dt == data_type_t::f16 && dst_dt == data_type_t::f16) {
        if (gamma_dt == data_type_t::f16 && beta_dt == data_type_t::f16) {
            row_fn = &layer_norm_row_fp16<float16_t, float16_t, float16_t,
                    float16_t>;
        } else if (gamma_dt == data_type_t::f16
                && beta_dt == data_type_t::f32) {
            row_fn = &layer_norm_row_fp16<float16_t, float16_t, float16_t,
                    float>;
        } else if (gamma_dt == data_type_t::f32
                && beta_dt == data_type_t::f16) {
            row_fn = &layer_norm_row_fp16<float16_t, float16_t, float,
                    float16_t>;
        } else if (gamma_dt == data_type_t::f32
                && beta_dt == data_type_t::f32) {
        ...
        if (gamma_dt == data_type_t::f16 && beta_dt == data_type_t::f16) {
            row_fn = &layer_norm_row_fp16<float16_t, float, float16_t,
                    float16_t>;
        } else if (gamma_dt == data_type_t::f16
                && beta_dt == data_type_t::f32) {
        ...
        if (gamma_dt == data_type_t::f16 && beta_dt == data_type_t::f16) {
            row_fn = &layer_norm_row_fp16<float, float16_t, float16_t,
                    float16_t>;
        } else if (gamma_dt == data_type_t::f16
                && beta_dt == data_type_t::f32) {
...
status_t layer_norm_avx512_fp16(
        const void *, void *, const void *, const void *, norm_params &) {
